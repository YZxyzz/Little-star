...
> ⚠️ **重要更新 (2026-02-08)**：外壳材质改为硅胶，更适合儿童实际使用场景

**实物设计特点**（基于参考图，材质升级为硅胶）：
...
2. **两只圆圆的硅胶眼睛** - 一体成型设计，简约温暖，无脱落风险
3. **无嘴巴的极简设计** - 让孩子自己投射情感
4. **Q弹柔软的触感** - 医用级硅胶，舒适安全
5. **奶油白/米白色** - 干净温暖，百搭不腻
6. **防水易清洁** - 可直接水洗，适合儿童使用场景

### 2.5 固定表情设计

> **重要说明**：实物硅胶玩偶采用固定表情设计，不可变换。
...
| 颜色名称 | 色值 | 使用场景 | 硅胶特性 |
|---------|------|---------|---------|
| **奶油白（主色）** | #FFF8E7 | 主要身体色（参考设计款）| 不易显脏，温暖治愈 |
| 眼睛深灰 | #2A2A2A | 一体成型硅胶眼睛 | 柔和不刺眼 |
| 云朵白 | #FFFFFF | 高光、装饰 | - |
| 腮红粉 | #FFAAAA | 可选脸颊红晕（变体款）| - |

### 3.2 色彩变体（硅胶套多色方案）

> **优势**：硅胶外壳可低成本提供多色选择，满足不同孩子喜好

| 版本 | 主色 | 色值 | 目标用户 | 备注 |
|------|------|------|---------|------|
| **奶油白（首选）** | 米白色 | #FFF8E7 | 全部 | 参考设计款 |
| 星空蓝 | 天蓝色 | #6B9BD2 | 男孩偏好 | 清新海洋风 |
| 樱花粉 | 粉色 | #FFB7C5 | 女孩偏好 | 甜美可爱 |
| 薄荷绿 | 绿色 | #98D4BB | 中性 | 清新自然 |
| 阳光橙 | 橙色 | #FFB366 | 活泼款 | 活力满满 |
| 梦幻紫 | 紫色 | #B8A9D9 | 神秘款 | 梦幻浪漫 |
