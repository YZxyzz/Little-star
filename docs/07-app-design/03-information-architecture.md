...
> 
> **更新日期**：2025-02-09
> **重大变更**：新增实时推送、成长里程碑、收藏夹等页面；报告详情页升级 v4.0
...
graph TD
    ...
    subgraph MainInterface[主界面 - 正常使用状态]
        ...
        Tab2 --> AIChat[🤖 AI对话入口]
        Tab2 --> GrowthFavorites[⭐ 成长收藏夹]
        Tab2 --> GrowthMilestones[🎯 成长里程碑]
        TopicCloud --> TopicDetail[话题详情页]
        ConversationFeed --> ConversationDetail
        AIChat --> AIChatWindow[AI对话窗口]
        GrowthFavorites --> FavoriteDetail[收藏详情]
        GrowthMilestones --> MilestoneDetail[里程碑详情]
...
*   **定位**：AI自动发现的孩子成长关键节点
*   **里程碑类型**：
    *   🧠 认知发展：首次提出哲学问题、理解抽象概念等
    *   ❤️ 情商发展：首次换位思考、主动道歉、安慰他人等
    *   👥 社交发展：建立友谊、解决冲突、表达边界等
    *   🎨 兴趣萌芽：持续关注某话题超过2周等
*   **每个里程碑**：
    *   发现时间
    *   触发事件（孩子原话）
